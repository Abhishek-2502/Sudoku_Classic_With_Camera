...
public class GridAndButtonUtils {
    ...
    static TypedValue typedValue1 = new TypedValue();
    static int colorForeground;
    static int colorBackground;

    public static void handleSudokuDigits(Button clickedButton, Context context,String tag) {
    ...
    public static void handleInputsButton(Button clickedButton, Context context) {
    ...
    public static void resetGrid(int grid[][],Context context){
        for (int i = 1; i <= 89; i++) {
...
//                System.out.println("Bi Input"+buttonIndex);
    ...
    public static boolean noZeroGrid(int grid[][]) {
        for(int row=0;row<9;row++){
            for(int col=0;col<9;col++){
